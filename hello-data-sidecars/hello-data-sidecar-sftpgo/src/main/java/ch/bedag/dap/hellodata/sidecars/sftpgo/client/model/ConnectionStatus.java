...
public class ConnectionStatus {
    ...
    @Override
    public String toString() {
        String sb = "class ConnectionStatus {\n" +
                "    username: " + toIndentedString(username) + "\n" +
                "    connectionId: " + toIndentedString(connectionId) + "\n" +
                "    clientVersion: " + toIndentedString(clientVersion) + "\n" +
                "    remoteAddress: " + toIndentedString(remoteAddress) + "\n" +
                "    connectionTime: " + toIndentedString(connectionTime) + "\n" +
                "    command: " + toIndentedString(command) + "\n" +
                "    lastActivity: " + toIndentedString(lastActivity) + "\n" +
                "    protocol: " + toIndentedString(protocol) + "\n" +
                "    activeTransfers: " + toIndentedString(activeTransfers) + "\n" +
