...
public class ConditionOptions {
    ...
    @Override
    public String toString() {
        String sb = "class ConditionOptions {\n" +
                "    names: " + toIndentedString(names) + "\n" +
                "    groupNames: " + toIndentedString(groupNames) + "\n" +
                "    roleNames: " + toIndentedString(roleNames) + "\n" +
                "    fsPaths: " + toIndentedString(fsPaths) + "\n" +
                "    protocols: " + toIndentedString(protocols) + "\n" +
                "    providerObjects: " + toIndentedString(providerObjects) + "\n" +
                "    minSize: " + toIndentedString(minSize) + "\n" +
                "    maxSize: " + toIndentedString(maxSize) + "\n" +
                "    concurrentExecution: " + toIndentedString(concurrentExecution) + "\n" +
                "}";
        return sb;
    }
