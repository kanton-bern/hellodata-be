...
public class FolderRetention {
    ...
    public String toString() {
        String sb = "class FolderRetention {\n" +
                "    path: " + toIndentedString(path) + "\n" +
                "    retention: " + toIndentedString(retention) + "\n" +
                "    deleteEmptyDirs: " + toIndentedString(deleteEmptyDirs) + "\n" +
                "    ignoreUserPermissions: " + toIndentedString(ignoreUserPermissions) + "\n" +
                "}";
        return sb;
    }
