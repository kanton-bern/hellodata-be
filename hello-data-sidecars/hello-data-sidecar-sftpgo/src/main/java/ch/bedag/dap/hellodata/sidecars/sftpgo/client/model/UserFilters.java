...
public class UserFilters {
    ...
    @Override
    public String toString() {
        String sb = "class UserFilters {\n" +
                "    allowedIp: " + toIndentedString(allowedIp) + "\n" +
                "    deniedIp: " + toIndentedString(deniedIp) + "\n" +
                "    deniedLoginMethods: " + toIndentedString(deniedLoginMethods) + "\n" +
                "    deniedProtocols: " + toIndentedString(deniedProtocols) + "\n" +
                "    filePatterns: " + toIndentedString(filePatterns) + "\n" +
                "    maxUploadFileSize: " + toIndentedString(maxUploadFileSize) + "\n" +
                "    tlsUsername: " + toIndentedString(tlsUsername) + "\n" +
                "    tlsCerts: " + toIndentedString(tlsCerts) + "\n" +
                "    hooks: " + toIndentedString(hooks) + "\n" +
                "    disableFsChecks: " + toIndentedString(disableFsChecks) + "\n" +
                "    webClient: " + toIndentedString(webClient) + "\n" +
                "    allowApiKeyAuth: " + toIndentedString(allowApiKeyAuth) + "\n" +
                "    userType: " + toIndentedString(userType) + "\n" +
                "    bandwidthLimits: " + toIndentedString(bandwidthLimits) + "\n" +
                "    externalAuthCacheTime: " + toIndentedString(externalAuthCacheTime) + "\n" +
                "    startDirectory: " + toIndentedString(startDirectory) + "\n" +
                "    twoFactorProtocols: " + toIndentedString(twoFactorProtocols) + "\n" +
                "    ftpSecurity: " + toIndentedString(ftpSecurity) + "\n" +
                "    isAnonymous: " + toIndentedString(isAnonymous) + "\n" +
                "    defaultSharesExpiration: " + toIndentedString(defaultSharesExpiration) + "\n" +
                "    maxSharesExpiration: " + toIndentedString(maxSharesExpiration) + "\n" +
                "    passwordExpiration: " + toIndentedString(passwordExpiration) + "\n" +
                "    passwordStrength: " + toIndentedString(passwordStrength) + "\n" +
                "    accessTime: " + toIndentedString(accessTime) + "\n" +
                "    requirePasswordChange: " + toIndentedString(requirePasswordChange) + "\n" +
                "    totpConfig: " + toIndentedString(totpConfig) + "\n" +
                "    recoveryCodes: " + toIndentedString(recoveryCodes) + "\n" +
                "}";
        return sb;
    }
