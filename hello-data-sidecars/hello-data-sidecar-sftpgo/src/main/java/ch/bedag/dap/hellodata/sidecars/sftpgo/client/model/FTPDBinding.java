...
public class FTPDBinding {
    ...
    @Override
    public String toString() {
        String sb = "class FTPDBinding {\n" +
                "    address: " + toIndentedString(address) + "\n" +
                "    port: " + toIndentedString(port) + "\n" +
                "    applyProxyConfig: " + toIndentedString(applyProxyConfig) + "\n" +
                "    tlsMode: " + toIndentedString(tlsMode) + "\n" +
                "    minTlsVersion: " + toIndentedString(minTlsVersion) + "\n" +
                "    forcePassiveIp: " + toIndentedString(forcePassiveIp) + "\n" +
                "    passiveIpOverrides: " + toIndentedString(passiveIpOverrides) + "\n" +
                "    clientAuthType: " + toIndentedString(clientAuthType) + "\n" +
                "    tlsCipherSuites: " + toIndentedString(tlsCipherSuites) + "\n" +
                "    passiveConnectionsSecurity: " + toIndentedString(passiveConnectionsSecurity) + "\n" +
                "    activeConnectionsSecurity: " + toIndentedString(activeConnectionsSecurity) + "\n" +
                "    ignoreAsciiTransferType: " + toIndentedString(ignoreAsciiTransferType) + "\n" +
