...
public class EventActionHTTPConfig {
    ...
    @Override
    public String toString() {
        String sb = "class EventActionHTTPConfig {\n" +
                ...
                "    skipTlsVerify: " + toIndentedString(skipTlsVerify) + "\n" +
                "    method: " + toIndentedString(method) + "\n" +
                "    queryParameters: " + toIndentedString(queryParameters) + "\n" +
                "    body: " + toIndentedString(body) + "\n" +
                "    parts: " + toIndentedString(parts) + "\n" +
                "}";
        return sb;
    }
