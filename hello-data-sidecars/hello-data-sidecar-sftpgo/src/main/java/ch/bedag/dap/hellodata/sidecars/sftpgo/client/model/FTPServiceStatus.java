 ...
 */
@JsonPropertyOrder({
        FTPServiceStatus.JSON_PROPERTY_IS_ACTIVE,
...
public class FTPServiceStatus {
    ...
    public FTPServiceStatus isActive(Boolean isActive) {
    ...
    public List<FTPDBinding> getBindings() {
    ...
    public JsonNullable<List<FTPDBinding>> getBindings_JsonNullable() {
        return bindings;
    }

    @JsonProperty(JSON_PROPERTY_BINDINGS)
    public void setBindings_JsonNullable(JsonNullable<List<FTPDBinding>> bindings) {
        this.bindings = bindings;
    }

    public FTPServiceStatus passivePortRange(FTPPassivePortRange passivePortRange) {
    ...
    /**
     * Get passivePortRange
     *
     * @return passivePortRange
     */
    @javax.annotation.Nullable
    @JsonProperty(JSON_PROPERTY_PASSIVE_PORT_RANGE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

    public FTPPassivePortRange getPassivePortRange() {
        return passivePortRange;
    }

    @JsonProperty(JSON_PROPERTY_PASSIVE_PORT_RANGE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setPassivePortRange(FTPPassivePortRange passivePortRange) {
        this.passivePortRange = passivePortRange;
    }

    @Override
    public int hashCode() {
        return Objects.hash(isActive, hashCodeNullable(bindings), passivePortRange);
    }
    ...
    public boolean equals(Object o) {
        ...
        FTPServiceStatus ftPServiceStatus = (FTPServiceStatus) o;
        return Objects.equals(this.isActive, ftPServiceStatus.isActive) &&
                equalsNullable(this.bindings, ftPServiceStatus.bindings) &&
                Objects.equals(this.passivePortRange, ftPServiceStatus.passivePortRange);
    }
