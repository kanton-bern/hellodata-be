...
public class ServicesStatus {
    ...
    public String toString() {
        String sb = "class ServicesStatus {\n" +
                "    ssh: " + toIndentedString(ssh) + "\n" +
                "    ftp: " + toIndentedString(ftp) + "\n" +
                "    webdav: " + toIndentedString(webdav) + "\n" +
                "    dataProvider: " + toIndentedString(dataProvider) + "\n" +
                "    defender: " + toIndentedString(defender) + "\n" +
                "    mfa: " + toIndentedString(mfa) + "\n" +
                "    allowList: " + toIndentedString(allowList) + "\n" +
                "    rateLimiters: " + toIndentedString(rateLimiters) + "\n" +
                "}";
        return sb;
    }
