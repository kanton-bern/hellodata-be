...
public class S3Config {
    ...
    public String toString() {
        String sb = "class S3Config {\n" +
                "    bucket: " + toIndentedString(bucket) + "\n" +
                "    region: " + toIndentedString(region) + "\n" +
                "    accessKey: " + toIndentedString(accessKey) + "\n" +
                "    accessSecret: " + toIndentedString(accessSecret) + "\n" +
                "    roleArn: " + toIndentedString(roleArn) + "\n" +
                "    sessionToken: " + toIndentedString(sessionToken) + "\n" +
                "    endpoint: " + toIndentedString(endpoint) + "\n" +
                "    storageClass: " + toIndentedString(storageClass) + "\n" +
                "    acl: " + toIndentedString(acl) + "\n" +
                "    uploadPartSize: " + toIndentedString(uploadPartSize) + "\n" +
                "    uploadConcurrency: " + toIndentedString(uploadConcurrency) + "\n" +
                "    uploadPartMaxTime: " + toIndentedString(uploadPartMaxTime) + "\n" +
                "    downloadPartSize: " + toIndentedString(downloadPartSize) + "\n" +
                "    downloadConcurrency: " + toIndentedString(downloadConcurrency) + "\n" +
                "    downloadPartMaxTime: " + toIndentedString(downloadPartMaxTime) + "\n" +
                "    forcePathStyle: " + toIndentedString(forcePathStyle) + "\n" +
                "    keyPrefix: " + toIndentedString(keyPrefix) + "\n" +
                "}";
        return sb;
    }
