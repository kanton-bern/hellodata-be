...
public class AzureBlobFsConfig {
    ...
    @Override
    public String toString() {
        String sb = "class AzureBlobFsConfig {\n" +
                "    container: " + toIndentedString(container) + "\n" +
                "    accountName: " + toIndentedString(accountName) + "\n" +
                "    accountKey: " + toIndentedString(accountKey) + "\n" +
                "    sasUrl: " + toIndentedString(sasUrl) + "\n" +
                ...
                "    accessTier: " + toIndentedString(accessTier) + "\n" +
                "    keyPrefix: " + toIndentedString(keyPrefix) + "\n" +
                "    useEmulator: " + toIndentedString(useEmulator) + "\n" +
                "}";
        return sb;
    }
