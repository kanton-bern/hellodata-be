...
public class FsEvent {
    ...
    public String toString() {
        String sb = "class FsEvent {\n" +
                "    id: " + toIndentedString(id) + "\n" +
                "    timestamp: " + toIndentedString(timestamp) + "\n" +
                "    action: " + toIndentedString(action) + "\n" +
                "    username: " + toIndentedString(username) + "\n" +
                "    fsPath: " + toIndentedString(fsPath) + "\n" +
                "    fsTargetPath: " + toIndentedString(fsTargetPath) + "\n" +
                "    virtualPath: " + toIndentedString(virtualPath) + "\n" +
                "    virtualTargetPath: " + toIndentedString(virtualTargetPath) + "\n" +
                "    sshCmd: " + toIndentedString(sshCmd) + "\n" +
                "    fileSize: " + toIndentedString(fileSize) + "\n" +
                "    elapsed: " + toIndentedString(elapsed) + "\n" +
                "    status: " + toIndentedString(status) + "\n" +
                "    protocol: " + toIndentedString(protocol) + "\n" +
                "    ip: " + toIndentedString(ip) + "\n" +
                "    sessionId: " + toIndentedString(sessionId) + "\n" +
                "    fsProvider: " + toIndentedString(fsProvider) + "\n" +
                "    bucket: " + toIndentedString(bucket) + "\n" +
                "    endpoint: " + toIndentedString(endpoint) + "\n" +
                "    openFlags: " + toIndentedString(openFlags) + "\n" +
