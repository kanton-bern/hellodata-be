...
public class EventConditions {
    ...
    @Override
    public String toString() {
        String sb = "class EventConditions {\n" +
                "    fsEvents: " + toIndentedString(fsEvents) + "\n" +
                "    providerEvents: " + toIndentedString(providerEvents) + "\n" +
                "    schedules: " + toIndentedString(schedules) + "\n" +
                "    idpLoginEvent: " + toIndentedString(idpLoginEvent) + "\n" +
