...
public class EventActionFilesystemConfig {
    ...
    public String toString() {
        String sb = "class EventActionFilesystemConfig {\n" +
                "    type: " + toIndentedString(type) + "\n" +
                "    renames: " + toIndentedString(renames) + "\n" +
                "    mkdirs: " + toIndentedString(mkdirs) + "\n" +
                "    deletes: " + toIndentedString(deletes) + "\n" +
                "    exist: " + toIndentedString(exist) + "\n" +
                "    copy: " + toIndentedString(copy) + "\n" +
                "    compress: " + toIndentedString(compress) + "\n" +
                "}";
        return sb;
    }
