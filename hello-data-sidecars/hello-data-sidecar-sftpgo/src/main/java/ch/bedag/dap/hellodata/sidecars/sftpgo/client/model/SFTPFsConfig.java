...
public class SFTPFsConfig {
    ...
    @Override
    public String toString() {
        String sb = "class SFTPFsConfig {\n" +
                "    endpoint: " + toIndentedString(endpoint) + "\n" +
                "    username: " + toIndentedString(username) + "\n" +
                "    password: " + toIndentedString(password) + "\n" +
                "    privateKey: " + toIndentedString(privateKey) + "\n" +
                "    keyPassphrase: " + toIndentedString(keyPassphrase) + "\n" +
                "    fingerprints: " + toIndentedString(fingerprints) + "\n" +
                "    prefix: " + toIndentedString(prefix) + "\n" +
                "    disableConcurrentReads: " + toIndentedString(disableConcurrentReads) + "\n" +
                "    bufferSize: " + toIndentedString(bufferSize) + "\n" +
                "    equalityCheckMode: " + toIndentedString(equalityCheckMode) + "\n" +
                "}";
        return sb;
    }
