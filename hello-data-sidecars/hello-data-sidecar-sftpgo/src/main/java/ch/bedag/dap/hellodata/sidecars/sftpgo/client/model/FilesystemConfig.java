...
public class FilesystemConfig {
    ...
    public String toString() {
        String sb = "class FilesystemConfig {\n" +
                "    provider: " + toIndentedString(provider) + "\n" +
                "    osconfig: " + toIndentedString(osconfig) + "\n" +
                "    s3config: " + toIndentedString(s3config) + "\n" +
                "    gcsconfig: " + toIndentedString(gcsconfig) + "\n" +
                "    azblobconfig: " + toIndentedString(azblobconfig) + "\n" +
                "    cryptconfig: " + toIndentedString(cryptconfig) + "\n" +
                "    sftpconfig: " + toIndentedString(sftpconfig) + "\n" +
