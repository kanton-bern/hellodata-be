...
public class AdminPreferences {
    ...
    public String toString() {
        String sb = "class AdminPreferences {\n" +
                "    hideUserPageSections: " + toIndentedString(hideUserPageSections) + "\n" +
                "    defaultUsersExpiration: " + toIndentedString(defaultUsersExpiration) + "\n" +
                "}";
        return sb;
    }
