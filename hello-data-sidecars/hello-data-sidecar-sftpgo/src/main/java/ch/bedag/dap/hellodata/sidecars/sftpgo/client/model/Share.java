...
public class Share {
    ...
    public String toString() {
        String sb = "class Share {\n" +
                ...
                "    lastUseAt: " + toIndentedString(lastUseAt) + "\n" +
                "    expiresAt: " + toIndentedString(expiresAt) + "\n" +
                "    password: " + toIndentedString(password) + "\n" +
                "    maxTokens: " + toIndentedString(maxTokens) + "\n" +
                "    usedTokens: " + toIndentedString(usedTokens) + "\n" +
                "    allowFrom: " + toIndentedString(allowFrom) + "\n" +
                "}";
        return sb;
    }
