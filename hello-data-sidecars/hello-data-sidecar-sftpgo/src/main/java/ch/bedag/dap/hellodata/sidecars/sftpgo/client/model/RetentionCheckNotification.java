 ...
 */
public enum RetentionCheckNotification {
  ...
  RetentionCheckNotification(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static RetentionCheckNotification fromValue(String value) {
    for (RetentionCheckNotification b : RetentionCheckNotification.values()) {
