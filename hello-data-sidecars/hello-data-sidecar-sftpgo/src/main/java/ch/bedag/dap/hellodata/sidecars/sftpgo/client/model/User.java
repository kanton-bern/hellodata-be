...
public class User {
    ...
    public String toString() {
        String sb = "class User {\n" +
                ...
                "    homeDir: " + toIndentedString(homeDir) + "\n" +
                "    virtualFolders: " + toIndentedString(virtualFolders) + "\n" +
                "    uid: " + toIndentedString(uid) + "\n" +
                "    gid: " + toIndentedString(gid) + "\n" +
                "    maxSessions: " + toIndentedString(maxSessions) + "\n" +
                "    quotaSize: " + toIndentedString(quotaSize) + "\n" +
                "    quotaFiles: " + toIndentedString(quotaFiles) + "\n" +
                "    permissions: " + toIndentedString(permissions) + "\n" +
                "    usedQuotaSize: " + toIndentedString(usedQuotaSize) + "\n" +
                "    usedQuotaFiles: " + toIndentedString(usedQuotaFiles) + "\n" +
                "    lastQuotaUpdate: " + toIndentedString(lastQuotaUpdate) + "\n" +
                "    uploadBandwidth: " + toIndentedString(uploadBandwidth) + "\n" +
                "    downloadBandwidth: " + toIndentedString(downloadBandwidth) + "\n" +
                "    uploadDataTransfer: " + toIndentedString(uploadDataTransfer) + "\n" +
                "    downloadDataTransfer: " + toIndentedString(downloadDataTransfer) + "\n" +
                "    totalDataTransfer: " + toIndentedString(totalDataTransfer) + "\n" +
                "    usedUploadDataTransfer: " + toIndentedString(usedUploadDataTransfer) + "\n" +
                "    usedDownloadDataTransfer: " + toIndentedString(usedDownloadDataTransfer) + "\n" +
                "    createdAt: " + toIndentedString(createdAt) + "\n" +
                "    updatedAt: " + toIndentedString(updatedAt) + "\n" +
                "    lastLogin: " + toIndentedString(lastLogin) + "\n" +
                "    firstDownload: " + toIndentedString(firstDownload) + "\n" +
                "    firstUpload: " + toIndentedString(firstUpload) + "\n" +
                "    lastPasswordChange: " + toIndentedString(lastPasswordChange) + "\n" +
                "    filters: " + toIndentedString(filters) + "\n" +
                "    filesystem: " + toIndentedString(filesystem) + "\n" +
                "    additionalInfo: " + toIndentedString(additionalInfo) + "\n" +
                "    groups: " + toIndentedString(groups) + "\n" +
                "    oidcCustomFields: " + toIndentedString(oidcCustomFields) + "\n" +
